...
public class ResumeListGetRequest {
    @Schema(
            description =
                    "검색할 포지션 (여러 개 가능) - BACKEND, FRONTEND, DEVOPS, FULL_STACK, DATA_ENGINEER",
            example = "[\"BACKEND\", \"FRONTEND\"]",
            allowableValues = {"BACKEND", "FRONTEND", "DEVOPS", "FULL_STACK", "DATA_ENGINEER"})
    private List<String> position;

    @Schema(description = "검색할 기수 (여러 개 가능)", example = "[1, 2, 3]")
    ...
    @Schema(description = "마지막으로 조회한 이력서의 ID", example = "0")
