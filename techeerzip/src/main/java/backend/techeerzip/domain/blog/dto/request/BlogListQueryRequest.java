...
public class BlogListQueryRequest {
    @Schema(
    ...
    @Schema(
            description = "정렬 기준 (latest: 최신순, viewCount: 조회수순, name: 이름순)",
            example = "latest",
            allowableValues = {"latest", "viewCount", "name"})
    @Pattern(
            regexp = "^(latest|viewCount|name)$",
            message = "정렬 기준은 latest, viewCount, name 중 하나여야 합니다.")
