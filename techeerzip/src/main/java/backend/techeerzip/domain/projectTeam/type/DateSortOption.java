...
public enum DateSortOption {
    UPDATE_AT_DESC_PROJECT(projectTeam.updatedAt.desc(), SortType.VIEW_COUNT_DESC, TeamType.PROJECT),
    UPDATE_AT_DESC_STUDY(studyTeam.updatedAt.desc(), SortType.VIEW_COUNT_DESC, TeamType.PROJECT);
    ...
    public static OrderSpecifier<LocalDateTime> setOrder(String sort, TeamType teamType) {
