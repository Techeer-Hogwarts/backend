 ...
 *
 * <p>TeamUnionView를 통해 조회된 페이징 결과를 담으며, 실제 팀 ID와 타입 정보만 담고
 * 상세 응답은 이후 각 도메인 서비스에서 ID 목록을 기반으로 재조회합니다.</p>
 *
 * <p>커서 기반 페이징을 위해 다음 페이지 정보인 {@code sliceNextInfo}를 함께 제공합니다.</p>
 *
 * <p>사용 예시:
 * <pre>{@code
