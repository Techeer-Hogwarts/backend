...
public class AuthService {
    ...
    public void login(HttpServletResponse response, LoginRequest loginRequest) {
        ...
        try {
            ...
            ResponseCookie accessToken = ResponseCookie.from("access_token", tokenPair.getAccessToken())
                    .httpOnly(true)
                    .secure(true)
                    .path("/")
                    .maxAge(60 * 60)
            ...
            ResponseCookie refreshToken = ResponseCookie.from("refresh_token", tokenPair.getRefreshToken())
                    .httpOnly(true)
                    .secure(true)
                    .path("/")
                    .maxAge(60 * 60 * 24 * 7)
