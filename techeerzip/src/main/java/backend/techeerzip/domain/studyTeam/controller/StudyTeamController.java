...
public class StudyTeamController implements StudyTeamSwagger {
    ...
    public ResponseEntity<Long> createStudyTeam(
        ...
        final StudyTeamCreateResponse response = studyTeamFacadeService.create(resultImages, request);
    ...
    public ResponseEntity<Long> updateStudyTeam(
        ...
        final StudyTeamUpdateResponse response = studyTeamFacadeService.update(studyTeamId, userId, resultImages, request);
    ...
    public ResponseEntity<Void> deleteStudyTeam(@PathVariable Long studyTeamId, @UserId Long userId) {
    ...
    public ResponseEntity<List<StudyApplicantResponse>> getApplicants(
        ...
        final List<StudyApplicantResponse> applicants = studyTeamFacadeService.getApplicants(studyTeamId, userId);
    ...
    public ResponseEntity<Void> applyToStudyTeam(
        ...
        List<StudySlackRequest.DM> slackRequest = studyTeamFacadeService.applyToStudy(request, userId);
    ...
    public ResponseEntity<Void> cancelApplication(@PathVariable Long studyTeamId, @UserId Long userId) {
        log.info("StudyTeam cancelApplication: 지원 취소 요청 - teamId={}, userId={}", studyTeamId, userId);
        List<StudySlackRequest.DM> slackRequest = studyTeamFacadeService.cancelApplication(studyTeamId, userId);
        eventPublisher.publishEvent(new SlackEvent.DM<>(slackRequest));
    ...
    public ResponseEntity<Void> acceptApplicant(@RequestBody StudyApplicantRequest request, @UserId Long userId) {
        log.info("StudyTeam acceptApplicant: 지원자 수락 요청 - userId={}", userId);
        List<StudySlackRequest.DM> slackRequest = studyTeamFacadeService.acceptApplicant(request, userId);
        eventPublisher.publishEvent(new SlackEvent.DM<>(slackRequest));
    ...
    public ResponseEntity<Void> rejectApplicant(@RequestBody StudyApplicantRequest request, @UserId Long userId) {
        log.info("StudyTeam rejectApplicant: 지원자 거절 요청 - userId={}", userId);
        List<StudySlackRequest.DM> slackRequest = studyTeamFacadeService.rejectApplicant(request, userId);
        eventPublisher.publishEvent(new SlackEvent.DM<>(slackRequest));
    ...
    @PostMapping("/members")
    public ResponseEntity<Void> addStudyMembers(@RequestBody StudyAddMembersRequest request, @UserId Long userId) {
        log.info("StudyTeam addStudyMembers: 멤버 추가 요청 - teamId={}, newMemberId={}, leader={}",
                request.studyTeamId(), request.studyMemberId(), request.isLeader());
        studyTeamFacadeService.addMemberToStudyTeam(request.studyTeamId(), userId, request.studyMemberId(), request.isLeader());
