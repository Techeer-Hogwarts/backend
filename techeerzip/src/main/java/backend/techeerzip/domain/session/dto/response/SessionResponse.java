...
public record SessionResponse(
        ...
        @Schema(description = "세션 제목", example = "Spring Boot 기초 강의")
        String title,

        @Schema(description = "발표자 이름", example = "김테커")
        String presenter,

        @Schema(description = "세션 날짜", example = "2024-03-20")
        String date,

        @Schema(description = "발표자 직책", example = "BACKEND")
        String position,

        @Schema(description = "세션 카테고리", example = "BOOTCAMP")
        String category,

        @Schema(description = "비디오 URL", example = "https://example.com/video.mp4")
        String videoUrl,

        @Schema(description = "파일 URL", example = "https://example.com/file.pdf")
        String fileUrl,
        ...
        @Schema(description = "생성일", example = "2025-02-25T07:48:06.558")
        LocalDateTime createdAt,

        @Schema(description = "수정일", example = "2025-04-09T11:38:50.297")
