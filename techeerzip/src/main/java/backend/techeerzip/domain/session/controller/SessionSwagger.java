        ...
        @ApiResponse(
                ...
                content = @Content(
                    ...
                    examples = @ExampleObject(
                        value = "{\"code\": \"C001\", \"message\": \"Invalid Input Value\", \"errors\": {\"title\": \"제목은 필수입니다.\"}}"
                    )
                )),
        @ApiResponse(
                responseCode = "401",
                ...
                content = @Content(
                    schema = @Schema(implementation = ErrorResponse.class),
                    examples = @ExampleObject(
                        value = "{\"code\": \"A002\", \"message\": \"유효하지 않은 JWT 토큰입니다.\", \"errors\": null}"
                    )
                ))
    })
    ...
    @ApiResponses({
        ...
        @ApiResponse(
                ...
                content = @Content(
                    schema = @Schema(implementation = ErrorResponse.class),
                    examples = @ExampleObject(
                        value = "{\"code\": \"SS003\", \"message\": \"해당 세션에 대한 권한이 없습니다.\", \"errors\": null}"
                    )
                )),
        @ApiResponse(
                responseCode = "404",
                ...
                content = @Content(
                    schema = @Schema(implementation = ErrorResponse.class),
                    examples = @ExampleObject(
                        value = "{\"code\": \"SS001\", \"message\": \"해당 세션을 찾을 수 없습니다\", \"errors\": null}"
                    )
                ))
    })
