                ...
                return GetUserResponse.builder()
                                ...
                                .projectTeams(
                                                user.getProjectMembers().stream()
                                                                .map(
                                                                                pm -> GetUserResponse.ProjectTeamDTO
                                                                                                .builder()
                                                                                                .id(pm.getProjectTeam()
                                                                                                                .getId())
                                                                                                .name(pm.getProjectTeam()
                                                                                                                .getName())
                                                                                                .resultImages(
                                                                                                                pm
                                                                                                                                .getProjectTeam()
                                ...
                                .studyTeams(
                                                user.getStudyMembers().stream()
                                                                .map(
                                                                                sm -> GetUserResponse.StudyTeamDTO
                                                                                                .builder()
                                                                                                .id(sm.getStudyTeam()
                                                                                                                .getId())
                                                                                                .name(sm.getStudyTeam()
                                                                                                                .getName())
                                                                                                .resultImages(
                                                                                                                sm
                                                                                                                                .getStudyTeam()
                                ...
                                .experiences(
                                                user.getExperiences().stream()
                                                                .map(
                                                                                exp -> GetUserResponse.ExperienceDTO
                                                                                                .builder()
                                                                                                .id(exp.getId())
