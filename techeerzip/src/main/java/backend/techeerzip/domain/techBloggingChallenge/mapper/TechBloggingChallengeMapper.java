...
public class TechBloggingChallengeMapper {
    ...
    public static RoundListResponse toRoundListResponse(List<TechBloggingRound> rounds) {
        List<RoundDetailResponse> roundDetails =
                rounds.stream().map(TechBloggingChallengeMapper::toRoundDetailResponse).toList();
        return RoundListResponse.builder().rounds(roundDetails).build();
    }

    public static TermSummaryResponse toTermSummaryResponse(
    ...
    public static TermRoundsSummaryResponse toTermRoundsSummaryResponse(
        ...
        List<TermRoundsSummaryResponse.RoundSummary> rounds =
                term.getRounds().stream()
                        ...
                        .map(
                                round ->
                                        TermRoundsSummaryResponse.RoundSummary.builder()
                                                .roundId(round.getId())
